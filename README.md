...
<details> <summary><strong>데이터 전체 조회 시 발생하는 프리징 현상을 Cursor 기반 페이지네이션 적용으로 개선</strong></summary>
...
<details> <summary><strong>페이지 접속할때 마다 전체 데이터를 읽던 최신 6개 일기장 조회를 Redis 캐싱으로 응답 속도 개선</strong></summary>
